...
model_list = ["NousResearch/Nous-Hermes-llama-2-7b", "NousResearch/Nous-Hermes-Llama2-13b", "NousResearch/Nous-Hermes-Llama2-70b","NousResearch/Nous-Hermes-2-Mixtral-8x7B-DPO","NousResearch/Nous-Hermes-2-Mixtral-8x7B-SFT"]
...
def TOGETHERCompletion(prompt: str, model: str, temperature: float = 0.75, **kwargs) -> str:
    ...
    return json.dumps({'response_str': response_json['output']['choices'][0]['text'], 
